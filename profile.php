                    ...
                    <div class="profile-header">
                        ...
                        <div class="profile-header-content">
                            <div class="profile-header-img">
                                <img src="assets/image/youssef.jpeg" alt="picture" />
                            </div>

                            <div class="profile-header-info">
                                <h4 class="m-t-sm">YOUSSEF RABI</h4>
                                <p class="m-b-sm">élève ingénieur d'etat </p>
                                        ...
                                        <table class="table table-profile">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="value">
                                                        <div class="m-b-5">
                                                            <b>cycle d ingénieur à l ecole marocaine de science d'ingenieur</b>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="value">
                                                        PHP, HTML5, CSS, jQuery, MYSQL , SQL ,Ionic, Laravel, Phonegap, Bootstrap, Angular JS, Angular JS, Asp.net,ado.net,python,React,java script
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <table class="table table-profile">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="value">
                                                    0667091152  / 0642020308
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="field">Email</td>
                                                    <td class="value">
                                                      youssefrabi32@gmail.com
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="field">Facebook</td>
                                                    <td class="value">
                                                        http://facebook.com/youssefrabi
                                                    </td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="col-md-4 hidden-xs hidden-sm">
                                <ul class="profile-info-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="value">1999/01/24</div>
                                    </li>
                                    <li>
                                        <div class="field">Country:</div>
                                        <div class="value">MAROC</div>
                                    </li>
                                    <li>
